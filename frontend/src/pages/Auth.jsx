...
export default function AccountPage() {
  return (
    <div className="row vh-100 justify-content-center bg-img">
      <div className="d-none d-md-flex flex-column justify-content-evenly flex-wrap col-md-4 mt-5 h-75">
        ...
        <div className="d-flex flex-column gap-5 text-light">
          <h3 className="px-5 fs-2 fw-bold">Commit to Fit,<br/> Commit to You</h3>
          <div
          ...
          >
            ...
            <div class="carousel-inner my-5 px-5">
